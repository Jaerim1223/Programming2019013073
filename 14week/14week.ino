...
void setup() {
 ...
 // for 문을 활용하여 i = 0 이라는 초기화식을 선언하고, sizeof를 통해 앞서 언급한 LED_pins의 배열을 불러와 OUTPUT으로 설정
...
void loop() {
  ...
  //만약에 현재 전압 currentVoltage가 이전 전압 previousVoltage 와 같지 않을때,이전 전압을 갱신  
